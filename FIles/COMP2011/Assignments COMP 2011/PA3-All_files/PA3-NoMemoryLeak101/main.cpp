...
int main()
{
    ...
    if(choice == 2) //play the game
    {
        ...
        int width = 10;  //map width
        int height = 10; //map height
        ...
        cout << "adding DAGGER: " << addThing(map, width, height, 2, 1, DAGGER, 1) << endl;
        cout << "adding SKELETON: " << addThing(map, width, height, 7, 2, SKELETON, 3) << endl;
        cout << "adding VAMPIRE: " << addThing(map, width, height, 3, 2, VAMPIRE, 3) << endl;
        cout << "adding MACE: " << addThing(map, width, height, 6, 3, MACE, 5) << endl;
        ...
        cout << "adding DAGGER: " << addThing(map, width, height, 2, 1, DAGGER, 1) << endl;
        cout << "adding SWORD: " << addThing(map, width, height, 3, 3, SWORD, 3) << endl;
        cout << "adding MACE: " << addThing(map, width, height, 9, 3, MACE, 1) << endl;
        cout << "adding SWORD: " << addThing(map, width, height, 3, 3, SWORD, 3) << endl;
        cout << "adding DAGGER: " << addThing(map, width, height, 9, 3, DAGGER, 5) << endl;
        cout << "adding DAGGER: " << addThing(map, width, height, 2, 1, DAGGER, 1) << endl;
        cout << "adding SWORD: " << addThing(map, width, height, 6, 6, SWORD, 3) << endl;
        cout << "adding DAGGER: " << addThing(map, width, height, 3, 3, DAGGER, 10) << endl;
        cout << "adding DAGGER: " << addThing(map, width, height, 9, 0, SWORD, 10) << endl;
        cout << "adding DAGGER: " << addThing(map, width, height, 8, 1, DRAGON, 10) << endl;
        addThing(map, width, height, 9, 9, DRAGON, 5);
        addThing(map, width, height, 9, 2, SWORD, 7);
        cout << "adding DAGGER: " << addThing(map, width, height, 9, 0, SWORD, 10) << endl;
        cout << "adding DAGGER: " << addThing(map, width, height, 8, 1, DRAGON, 10) << endl;
        for(int k =0; k<10;k++){
            removeThing(map, width, height, 9, 0, SWORD, 1);
        }
        for(int k=0;k<10;k++){
            removeThing(map, width, height, 8, 1, DRAGON, 1);
        }
    ...
    else if(choice == 1) //test the test cases
    {
        ...
        cout << boolalpha; //to show true/false for booleans in console
