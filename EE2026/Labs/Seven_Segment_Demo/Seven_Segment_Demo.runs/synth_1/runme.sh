...
HD_PWD='C:/Users/denni/Documents/dac70r.github.io/EE2026/Labs/Seven_Segment_Demo/Seven_Segment_Demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_Segment_Demo_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Seven_Segment_Demo_Top.tcl
