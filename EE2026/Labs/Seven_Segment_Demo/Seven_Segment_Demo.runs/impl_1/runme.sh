...
HD_PWD='C:/Users/denni/Documents/dac70r.github.io/EE2026/Labs/Seven_Segment_Demo/Seven_Segment_Demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_Segment_Demo_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Seven_Segment_Demo_Top.tcl -notrace
