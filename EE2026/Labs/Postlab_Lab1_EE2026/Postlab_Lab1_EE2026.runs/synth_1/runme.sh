...
HD_PWD='C:/Users/Dennis Wong/Postlab_Lab1_EE2026/Postlab_Lab1_EE2026.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_Segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Seven_Segment.tcl
