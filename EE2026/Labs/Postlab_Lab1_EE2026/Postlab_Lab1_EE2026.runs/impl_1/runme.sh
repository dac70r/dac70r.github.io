...
HD_PWD='C:/Users/Dennis Wong/Postlab_Lab1_EE2026/Postlab_Lab1_EE2026.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_Segment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Seven_Segment.tcl -notrace
