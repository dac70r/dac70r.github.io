...
module Postlab3_Top(input CLOCK, input switch, input btnR, input btnU, input btnL, input btnC, input [2:0] sw, 
                    output reg [6:0]seg=7'b111_1111, output reg dp = 1'b1, output reg [3:0]an=4'b1111,
                    output reg unlocked_led = 1'b0, output reg led_14, output reg led_13, output reg led_12, 
...
//reg [1:0] count_subtaskC_1hz = 0;
//reg [1:0] count_subtaskC_10hz = 0;
//reg [1:0] count_subtaskC_100hz = 0;
