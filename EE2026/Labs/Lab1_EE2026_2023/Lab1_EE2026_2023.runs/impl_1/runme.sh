...
HD_PWD='C:/Users/Dennis Wong/Lab1_EE2026_2023/Lab1_EE2026_2023.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_Module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_Module.tcl -notrace
