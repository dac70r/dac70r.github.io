...
HD_PWD='C:/Users/guan-ming.dennis-won/Reset_Synchronizer/Reset_Synchronizer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Reset_Synchronizer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Reset_Synchronizer.tcl
